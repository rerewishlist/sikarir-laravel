                    ...
                    <div class="card-body pt-3">
                        ...
                        <div class="tab-content pt-2">
                            ...
                            <div class="tab-pane fade show active profile-edit pt-3" id="profile-edit">
                                <form method="post" action="{{ route('informasi.update') }}" enctype="multipart/form-data">
                                    @csrf
                                    @method('patch')
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input type="text" class="form-control @error('instansi') is-invalid @enderror" name="instansi"
                                                id="fullName" placeholder="Instansi" value="{{ $informasi->instansi }}">
                                            @error('instansi')
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input type="text" class="form-control @error('alamat') is-invalid @enderror" name="alamat"
                                                id="fullName" placeholder="Alamat" value="{{ $informasi->alamat }}">
                                            @error('alamat')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input type="text" class="form-control @error('nohp') is-invalid @enderror" name="nohp"
                                                id="fullName" placeholder="No HP" value="{{ $informasi->nohp }}">
                                            @error('nohp')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input type="email" class="form-control @error('email') is-invalid @enderror" name="email"
                                                id="fullName" placeholder="Email" value="{{ $informasi->email }}">
                                            @error('email')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input type="text" class="form-control @error('deskripsi') is-invalid @enderror" name="deskripsi"
                                                id="fullName" placeholder="Deskripsi" value="{{ $informasi->deskripsi }}">
                                            @error('deskripsi')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input type="text" class="form-control @error('videoyt') is-invalid @enderror" name="videoyt"
                                                id="fullName" placeholder="Masukan link video youtube" value="{{ $informasi->videoyt }}">
                                            @error('videoyt')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input type="text" class="form-control @error('facebook') is-invalid @enderror" name="facebook"
                                                id="fullName" placeholder="Facebook" value="{{ $informasi->facebook }}">
                                            @error('facebook')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input type="text" class="form-control @error('instagram') is-invalid @enderror" name="instagram"
                                                id="fullName" placeholder="Instagram" value="{{ $informasi->instagram }}">
                                            @error('instagram')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input type="text" class="form-control @error('twitter') is-invalid @enderror" name="twitter"
                                                id="fullName" placeholder="Twitter" value="{{ $informasi->twitter }}">
                                            @error('twitter')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input type="text" class="form-control @error('youtube') is-invalid @enderror" name="youtube"
                                                id="fullName" placeholder="Youtube" value="{{ $informasi->youtube }}">
                                            @error('youtube')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input type="text" class="form-control @error('tiktok') is-invalid @enderror" name="tiktok"
                                                id="fullName" placeholder="Tiktok"value="{{ $informasi->tiktok }}">
                                            @error('tiktok')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
